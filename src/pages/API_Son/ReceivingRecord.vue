        ...
        <el-card class="box-card" style="width: 100%;height: 100%;">
            ...
            <div class="main">
                ...
                <el-table v-loading="loading"  :data="tableData" :default-sort="{ prop: 'date', order: 'descending' }" style="width: 100%">
                    ...
                    <el-table-column prop="name" label="号段" />
                    <el-table-column prop="name" label="扣款金额" sortable/>
                    <el-table-column prop="name" label="下单时间" sortable/>
                    <el-table-column prop="name" label="完成时间" sortable/>
